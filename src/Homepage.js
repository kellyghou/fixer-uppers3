    ...
    return (
        <div>
            ...
            <main className='homepage-content'>
                ...
                <Button variant='contained' href='explore/:category?' sx={{display: 'block', margin: 'auto', width: '10rem', textAlign: 'center', marginBottom: '2rem', marginTop: '2rem'}}>Get Started</Button>
